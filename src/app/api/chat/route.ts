...
// Shared contact lines used in responses — built from SITE config
const CONTACT_ES = `📞 **${SITE.phone}**\n💬 **WhatsApp**: +1 ${SITE.phoneRaw}\n📧 **${SITE.email}**`;
const CONTACT_EN = `📞 **${SITE.phone}**\n💬 **WhatsApp**: +1 ${SITE.phoneRaw}\n📧 **${SITE.email}**`;
